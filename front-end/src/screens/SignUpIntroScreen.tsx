  ...
  const SignUpScreen: React.FC<SignUpIntroScreenProps> = ({navigation}) => {
    ...
    const updateAge = async (age: number) => {
      ...
      const handleSignUpIntro = async () => {
        ...
        if (isNaN(Number(age)) || isNaN(Number(weight)) || isNaN(Number(user_height))) {
    ...
    return (
      ...
      <View style={styles.bg_white}>
        ...
        <View style={[styles.mg_v_8, styles.mg_h_16]}>
          ...
          />
          <Text style={[styles.mg_t_8, styles.font_inter_input]}>Weight (lbs)</Text>
          <TextInput
            placeholder="Weight"
            style={[styles.mg_v_8, styles.text_input]}
            color="rgba(251, 142, 64, 0.5)"
          ...
          <Text style={[styles.mg_t_8, styles.font_inter_input]}>Height (cm)</Text>
          <TextInput
            placeholder="Height"
            style={[styles.mg_v_8, styles.text_input]}
            color="rgba(251, 142, 64, 0.5)"
          ...
          />
          <Text style={[styles.mg_t_8, styles.font_inter_input, styles.smallerText]}>*These fields above are not required</Text>
      ...
      {expanded && (
        <Text style={[styles.mg_t_8, styles.font_inter_input]}>
    FitBook is a unique fitness social media platform that integrates fitness tracking with social connectivity. 
    Our primary goal is to inspire and motivate individuals to adopt and maintain a regular physical activity routine, all within a vibrant and supportive community.

    With FitBook, you can effortlessly share your workouts, repost engaging fitness content, and keep track of your personal progress. 
    We aim to create an environment that uplifts individuals on their fitness journey.
    Let's strive together towards a healthier and happier lifestyle!
        </Text>
      )}
